...
function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center p-4 bg-white shadow-md">
      ...
      <div className="flex space-x-6 font-bold relative">
      ...
      <div>
        ...
        <div className='flex font-bold space-x-1'>
          <button className="w-19 h-3 flex hover:underline" onClick={()=>{Navigate("/login")}}>LOG IN</button>
          <p>/</p>
          <button className="w-20 h-3 flex hover:underline"onClick={()=>{Navigate("/signup")}}>REGISTER</button>
        </div>
      </div>
      ...
      <div className="flex ml-0 relative">
        ...
        />
        <div className="absolute top-1/4 left-1/4 w-5 h-5 bg-green-500 rounded-full transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center text-white text-xs">
          5
        </div>
        <div>
          <div className="text-gray-700 font-light text-xs">CART</div>
          <div className='flex font-bold space-x-1'>
            <div className='ml-5'>$1,689.00</div>
          </div>
        </div>
      </div>
    </div>
