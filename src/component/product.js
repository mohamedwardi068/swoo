...
function Product({ name, price, priceRange, specs, image, originalPrice, discount, shipping, availability }) {
  ...
  return (
    <>
      <div className="h-auto text-center relative">
        {discount != null && !priceRange && (
          <div className={`${isSpecialProduct ? 'bg-blue-600' : 'bg-green-600'} text-white py-1 px-2 rounded absolute top-4 left-4 text-xs w-[50px] h-[50px]`}>
