    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div  className="p-4  bg-gray-100 rounded-md w-[524.16px] h-[380px] ">
          ...
          <div className="p-4   ">
            <h3 className="font-bold mb-2">UNITED STATES (HEAD QUARTER)</h3>
            <p>152 Thatcher Road St, Mahattan, 10463, US</p>
            <p>(+025) 3886 25 16</p>
            <p><a href="mailto:hello@swatechmart.com" className="text-green-500">hello@swatechmart.com</a></p>
          </div>
          <div className="p-4   ">
            <h3 className="font-bold mb-2">UNITED KINGDOM (BRANCH)</h3>
            <p>12 Buckingham Rd, Thornthwaite, HG3 4TY, UK</p>
            <p>(+718) 895-5350</p>
            <p><a href="mailto:contact@swatechmart.co.uk" className="text-green-500">contact@swatechmart.co.uk</a></p>
          </div>
          <div >
