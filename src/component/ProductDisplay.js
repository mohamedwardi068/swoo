      ...
      <div className="rounded-lg border bg-white shadow-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-5">
            ...
            <div
              className={`py-1 px-2 rounded-md inline-block mt-3 font-serif  ${shipping === 'Free Shipping' ? 'text-green-600' : 'text-black'
                } bg-gray-200`}
            >
            ...
            <div className="mt-4 flex items-center space-x-4 text-3xl text-gray-600">
