  ...
  return (
    <>
      ...
      <BrowserRouter>
        ...
        <Routes >
 <Route index element={<><Header /><Navbar /><Searchbar /><Storytech /><ListBestseller /><hr className="border-t-2 border-gray-300 mt-12 mb-2 ml-4 sm:ml-12 md:ml-24 lg:ml-[25%] w-[75%] sm:w-[80%] md:w-[85%] lg:w-[75%]" /><ListProduct /><hr className="border-0 mt-12 mb-8 sm:mt-16 sm:mb-10 md:mt-[5%] md:mb-[3%]" /><Footer/> </>}/>
